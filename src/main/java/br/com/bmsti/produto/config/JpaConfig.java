package br.com.bmsti.produto.config;
...
@Configuration
@EnableJpaRepositories(basePackages = "br.com.bmsti.produto.repository", entityManagerFactoryRef = "entityManagerFactory", transactionManagerRef = "transactionManager")
...
public class JpaConfig {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "br.com.bmsti.produto.entity" });
